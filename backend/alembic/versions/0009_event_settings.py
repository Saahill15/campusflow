...
def upgrade():
    op.create_table(
        ...
        sa.Column('allow_check_in', sa.Boolean(), nullable=False, server_default=sa.text('1')),
        sa.Column('allow_reentry', sa.Boolean(), nullable=False, server_default=sa.text('0')),
        sa.Column('allow_duplicate_scan', sa.Boolean(), nullable=False, server_default=sa.text('0')),
        sa.Column('require_active_qr', sa.Boolean(), nullable=False, server_default=sa.text('1')),
        sa.Column('require_active_pass', sa.Boolean(), nullable=False, server_default=sa.text('1')),
        sa.Column('require_approved_registration', sa.Boolean(), nullable=False, server_default=sa.text('1')),
