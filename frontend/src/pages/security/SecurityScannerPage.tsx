...
export default function SecurityScannerPage() {
  ...
  useEffect(() => {
    ...
    api.get<Gate[]>('/security/gates').then((response) => {
      ...
      else setApiError('No active event gate is available.')
