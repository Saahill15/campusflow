        ...
        <div className="relative z-10 flex min-h-screen flex-col items-center justify-center overflow-hidden px-3 py-20 text-center sm:px-4 md:px-8">
          ...
          >
            ...
            <motion.h1
              ...
              className="mx-auto w-full max-w-[min(100%,58rem)] whitespace-nowrap text-center text-[clamp(2.6rem,7vw,9.5rem)] font-black leading-[0.82] tracking-[-0.02em] text-[#E0D0B6] sm:tracking-[-0.04em]"
            >
              <span className="block tracking-[0.02em] sm:tracking-[0.04em]">PRAGYARAMBH</span>
              <span className="mt-1 block tracking-[0.06em] text-[clamp(2.0rem,3.7vw,6.4rem)] text-[#CC9E4C] leading-[0.8] sm:tracking-[0.08em]">3.0</span>
            </motion.h1>
